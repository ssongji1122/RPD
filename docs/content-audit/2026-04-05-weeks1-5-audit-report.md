...
> **감사 방법:** Week 6 파일럿 동일 방식 적용 (Rubric 5차원 × 5주차)
> **감사자:** Content Lead
> **감사일:** 2026-04-05
...
| 주차 | 주제 | 학습목표 구체성 | 전제 명시 | Stuck Map | 시간배분 현실성 | 평가 정합성 | **총점** |
|------|------|:-:|:-:|:-:|:-:|:-:|:-:|
| Week 1 | 오리엔테이션 + AI 무드보드 | 3 | 4 | 3 | 3 | 2 | **15/25** |
| Week 2 | Blender 인터페이스 + MCP | 3 | 3 | 3 | 2 | 1 | **12/25** |
| Week 3 | 기초 모델링 1 (Edit + Modifier) | 4 | 4 | 3 | 3 | 4 | **18/25** |
| Week 4 | 기초 모델링 2 (디테일 + 음영) | 4 | 3 | 3 | 3 | 2 | **15/25** |
| Week 5 | AI 3D 생성 + Sculpting | 4 | 4 | 3 | 4 | 3 | **18/25** |
| **Week 6** | **Material & Shader (파일럿)** | **4** | **3** | **3** | **3** | **2** | **15/25** |

> **비교 기준:** Week 6 파일럿 점수 15/25 (평균)
> **Week 1-5 평균:** 15.6/25 — Week 6 파일럿과 비슷한 수준
...
| 시간 배분 현실성 | 3.0 | Week 2 특히 위험(점수 2). Week 5는 양호(점수 4). 나머지는 타이트함 |
