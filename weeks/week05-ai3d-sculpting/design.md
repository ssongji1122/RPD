...
| 시간 | 내용 | 비율 |
|------|------|------|
| 00:00-00:10 | 인트로, Week 4 복습, AI 3D 개요 | 6% |
| 00:10-00:25 | 이론: AI 3D 도구 비교 (Meshy/Tripo/Luma) + 한계 | 8% |
| 00:25-00:50 | 실습: Meshy AI Text to 3D 생성 + 임포트 | 14% |
| 00:50-01:05 | 실습: Tripo AI Image to 3D (Week 1 컨셉 이미지 활용) | 8% |
| 01:05-01:20 | 실습: Blender 임포트 + 스케일 조정 + Apply Transform | 8% |
| 01:20-01:30 | Before 스크린샷 촬영 + Voxel Remesh | 6% |
| 01:30-02:00 | **중간 휴식 + AI 모델 생성 대기 시간** | - |
| 02:00-02:30 | 실습: Sculpt Mode (Smooth, Grab, Draw, Clay Strips) | 17% |
| 02:30-02:45 | 실습: After 스크린샷 + Blender MCP 데모 (선택) | 8% |
| 02:45-03:00 | 과제 안내 + Week 6 .blend 파일 저장 안내 + 마무리 | 8% |

**실습 : 강의 비율** = 약 70% : 30%

> ⚠️ **현실성 주의:** Meshy AI 생성 시간 3-5분 + Tripo AI 생성 시간 5-10분 → 중간 대기 시간 발생. 이 시간을 활용해 Sculpt 이론을 설명하거나 Week 1 컨셉 이미지를 준비하도록 유도. MCP 실습은 시간 여유 있을 때만 진행하는 선택 옵션으로 명시.
...
| 4. 시간 배분 현실성 | 4 | AI 생성 대기 시간을 이론/준비 시간으로 활용하는 구조가 합리적. MCP가 선택으로 명시되어 시간 초과 위험 낮음. |
| 5. 평가 정합성 | 3 | curriculum.js가 assignment.md보다 더 구체적이고 Week 6 연결 안내 포함. 방향 불일치는 아니나 세부 체크리스트 통일 필요. P1 수준. |
