...
- 핵심 키워드: AI 툴 활용 · Sculpt Mode 기초 · 메쉬 정리
- 예상 시간: ~3시간
...
- Sculpt Mode → Remesh 버튼 또는 Ctrl+R (Voxel Size를 조절해서 해상도 맞추기)
- Remesh 전후 비교해보기 (메쉬가 고르게 나뉘었는지 확인)
- 최종 형태 Object Mode에서 확인 후 스크린샷
