...
- [x] **시간 배분 재조정 (이 커밋):** 학습 목표를 핵심 5개 + 부가 5개로 분리. 강사 노트에 "MCP 실패 시 과제로 이월" 가이드 추가. ✅
...
| 4. 시간 배분 현실성 | 2 | 4 | 우선순위 가이드 + MCP 이월 옵션 명시로 현실적 플랜 확보 |
| 5. 평가 정합성 | 1 | 5 | P0 불일치 2건 모두 해결 (curriculum.js, lecture-note.md) |
