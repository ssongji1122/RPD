...
var SHOWME_REGISTRY = {
  "fbx-export-settings": { label: "FBX Export 설정", icon: "settings", week: 12, category: "rigging" },
  "accurig-workflow": { label: "AccuRIG 자동 리깅 워크플로", icon: "refresh-cw", week: 12, category: "rigging" },
  "mixamo-autorig": { label: "Mixamo 자동 리깅", icon: "cloud", week: 12, category: "rigging" },
  "ik-fk": { label: "IK vs FK 이해", icon: "move-horizontal", week: 11, category: "rigging" },
  "bone-parent-types": { label: "Bone Parent 종류 (Connected vs Free)", icon: "link", week: 11, category: "rigging" },
  "rigify-basics": { label: "Rigify 자동 리깅", icon: "bot", week: 11, category: "rigging" },
