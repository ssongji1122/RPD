(function(win) {
  ...
  var COPY = {
    ...
    index: {
      ko: {
        pageTitle: "Blender Archive - RPD",
        metaDescription: "Blender Archive와 인하대학교 RPD 수업 조합 허브",
        topbarTitle: "Blender Archive",
        topbarMeta: "Archive Hub · Inha University",
        libraryLink: "◫ 카드 라이브러리",
        shortcutsLink: "\u2328 단축키 DB",
        themeToggleAria: "테마 전환",
        heroEyebrow: "Blender Archive",
        heroTitle: "수업용 블렌더 아카이브",
        heroDescription: "Show Me 카드와 단축키, 주차별 실습 구성을 한 허브에서 관리하고 각 수업은 필요한 카드만 조합해서 만들어요.",
        heroMetaLabel: "현재 구조",
        heroMetaArchive: "개념 카드와 도구 기준점",
        ...
        archiveSectionDescription: "개념 카드, 단축키, 조합된 수업 페이지를 분리해두면 한 수업을 고칠 때 전체 구조를 다시 만들 필요가 없어요.",
        archiveCardLibraryKicker: "Card Library",
        archiveCardLibraryTitle: "Show Me 카드 아카이브",
        ...
        archiveCardShortcutTitle: "단축키 베이스",
        ...
        archiveCardAssemblyTitle: "수업 조합 페이지",
        archiveCardAssemblyCopy: "실습 카드와 Show Me 카드, 참고 자료를 묶어 학교별 커스텀 수업 페이지로 보여줍니다.",
        archiveCardAssemblyMeta: "주차 조합",
        programEyebrow: "Custom Course Collection",
        programTitle: "인하대학교 · Robot Product Design",
        programDescription: "15주 RPD 수업은 Blender Archive의 카드 조합으로 보이는 인하대학교 맞춤 페이지예요.",
        programStatWeeks: "주차 조합",
        programStatCards: "연결된 아카이브 카드",
        programStatActive: "현재 진행 주차",
        weekSectionEyebrow: "Week Assemblies",
        weekSectionTitle: "주차별 수업 조합",
        weekSectionDescription: "각 주차는 필요한 실습 카드, Show Me 카드, 참고 자료를 묶어서 하나의 수업 페이지로 구성합니다.",
        footerLabel: "Blender Archive · RPD 2026",
        activeLabel: "현재 수업 조합",
        badgeExam: "시험 주차",
        badgeDone: "완료",
        badgeActive: "진행 중",
        badgeUpcoming: "예정",
      ...
      en: {
        pageTitle: "Blender Archive - RPD",
        metaDescription: "Blender Archive hub for the Inha University RPD course collection",
        topbarTitle: "Blender Archive",
        topbarMeta: "Archive Hub · Inha University",
        ...
        heroEyebrow: "Blender Archive",
        heroTitle: "A Blender archive for building courses",
        heroDescription: "Keep Show Me cards, shortcuts, and weekly lesson structures in one hub, then assemble each class from only the cards it needs.",
        heroMetaLabel: "Current structure",
        heroMetaArchive: "Reusable concept cards",
        heroMetaProgram: "Inha University RPD collection",
        heroMetaActivePrefix: "Current assembly",
        heroMetaActiveFallback: "No active week yet",
        heroPrimaryCta: "Go to current week",
        heroSecondaryCta: "Open card library",
        heroTertiaryCta: "View shortcuts DB",
        archiveSectionEyebrow: "Archive Layers",
        archiveSectionTitle: "The archive keeps only reusable building blocks",
        archiveSectionDescription: "Separating concept cards, shortcut references, and assembled lesson pages makes it much easier to update one course without rebuilding the whole system.",
        archiveCardLibraryKicker: "Card Library",
        archiveCardLibraryTitle: "Show Me card archive",
        ...
        archiveCardShortcutKicker: "Shortcut Base",
        archiveCardShortcutTitle: "Shortcut base",
        ...
        archiveCardAssemblyKicker: "Course Assembly",
        archiveCardAssemblyTitle: "Lesson assembly pages",
        archiveCardAssemblyCopy: "Bundle practice cards, Show Me cards, and references into school-specific lesson pages.",
        archiveCardAssemblyMeta: "week assemblies",
        programEyebrow: "Custom Course Collection",
        programTitle: "Inha University · Robot Product Design",
        programDescription: "This 15-week RPD course is presented as an Inha University custom page assembled from Blender Archive cards.",
        programStatWeeks: "week assemblies",
        programStatCards: "linked archive cards",
        programStatActive: "current week",
        weekSectionEyebrow: "Week Assemblies",
        weekSectionTitle: "Weekly lesson assemblies",
        weekSectionDescription: "Each week bundles the practice cards, Show Me cards, and references needed for that specific lesson page.",
        footerLabel: "Blender Archive · RPD 2026",
        activeLabel: "Current lesson assembly",
        badgeExam: "Exam Week",
        badgeDone: "Done",
    ...
    week: {
      ko: {
        ...
        modalBrowseSearchPlaceholder: "연관 카드나 키워드 검색",
        modalBrowseCurrent: "이번 주 카드",
        modalBrowseRelated: "연관 카드",
        modalBrowseResults: "검색 결과",
        modalBrowseEmpty: "조건에 맞는 Show Me 카드가 없습니다.",
        modalBrowseLibraryLink: "전체 라이브러리 열기",
        loginTitle: "\ud83d\udc4b 바로 시작하세요",
        ...
        bundleLibraryLink: "Show Me 카드 라이브러리",
        ...
        sectionPractice: "이번 수업 카드 조합",
        sectionPracticeDesc: "아래 카드 순서대로 따라가면 인하대학교 RPD 이번 주차 수업 흐름이 됩니다.",
      ...
      en: {
        ...
        modalBrowseSearchPlaceholder: "Search related cards or keywords",
        modalBrowseCurrent: "This week",
        modalBrowseRelated: "Related cards",
        modalBrowseResults: "Search results",
        modalBrowseEmpty: "No Show Me cards match this view.",
        modalBrowseLibraryLink: "Open full library",
        ...
        bundleLibraryLink: "Show Me card library",
        ...
        sectionPractice: "This week's lesson assembly",
        sectionPracticeDesc: "Follow the cards below in order to move through this week's Inha University RPD lesson flow.",
    ...
    library: {
      ...
      en: {
        ...
        subtitle: "Start from the Blender Manual flow, then narrow down with search and ABC when you need something specific",
    ...
    shortcuts: {
      ko: {
        ...
        heroTitle: "단축키 DB",
        heroDescription: "수업에서 다루는 모든 Blender 단축키를 한 곳에서 검색하세요.",
      ...
      en: {
        ...
        heroDescription: "Search every Blender shortcut used in this course in one place.",
