  ...
  var COPY = {
    ...
    index: {
      ko: {
        ...
        topbarMeta: "studio.soluta · Inha University",
        libraryLink: "카드 라이브러리",
        shortcutsLink: "단축키 DB",
        themeToggleAria: "테마 전환",
        heroEyebrow: "studio.soluta × Inha",
        heroTitle: "Robot Product Design",
        heroDescription: "이번 주 실습, Show Me 카드, 참고자료를 한 페이지에서 확인합니다. 필요한 주차만 골라 바로 열 수 있어요.",
        heroMetaLabel: "학습 구조",
        ...
        programDescription: "15주 RPD 수업을 studio.soluta의 paper editorial 톤으로 정리한 인하대학교 맞춤 학습 허브입니다.",
        programStatWeeks: "주차",
        ...
        footerLabel: "studio.soluta · RPD 2026",
        activeLabel: "현재 주차",
        badgeExam: "시험 주차",
        badgeDone: "완료",
        badgeActive: "진행 중",
      ...
      en: {
        ...
        heroEyebrow: "studio.soluta × Inha",
        heroTitle: "Robot Product Design",
        heroDescription: "This week's practice, Show Me cards, and references are gathered on one course hub. Open only the weeks you need.",
        ...
        programDescription: "The 15-week RPD curriculum is organized as a studio.soluta paper editorial course hub for Inha University.",
