  ...
  var COPY = {
    ...
    index: {
      ko: {
        ...
        heroDescription: "카드와 단축키를 아카이브로 정리해두고, 필요한 주차 수업만 조합해 엽니다.",
        heroMetaLabel: "현재 구조",
        ...
        archiveSectionDescription: "카드와 단축키만 공통으로 관리하고, 실제 수업은 필요한 주차만 조합합니다.",
      ...
      en: {
        ...
        heroDescription: "Keep cards and shortcuts in one archive, then open only the lesson weeks you need.",
