...
const CURRICULUM = [
  {
    ...
    "shortcuts": [
      { "keys": "LMB", "action": "선택 (Left Mouse Button)" },
      { "keys": "Ctrl + S", "action": "파일 저장" },
      { "keys": "Ctrl + Z", "action": "되돌리기 (Undo)" },
      { "keys": "Ctrl + Shift + Z", "action": "다시 실행 (Redo)" }
    ],
    "docs": [
      { "title": "Blender 설치 가이드", "url": "https://docs.blender.org/manual/en/latest/getting_started/installing/index.html" },
      { "title": "시작하기", "url": "https://docs.blender.org/manual/en/latest/getting_started/index.html" }
    ],
    "videos": [
      {
  ...
  },
  {
    ...
    "shortcuts": [
      ...
      { "keys": "Ctrl + R (Sculpt)", "action": "Voxel Remesh" },
      { "keys": "Ctrl + Z", "action": "되돌리기" },
      { "keys": "X", "action": "Draw 브러시 빠른 선택" }
    ],
    "explore": [
      {
        "title": "AI 프롬프트 실험",
  ...
  },
  {
    ...
    "shortcuts": [
      ...
      { "keys": "M", "action": "노드 Frame 그룹 만들기" },
      { "keys": "H", "action": "노드 숨기기/접기" },
      { "keys": "Ctrl + Right Click", "action": "노드 연결선 끊기" }
    ],
    "explore": [
      {
        "title": "로봇 파츠별 재질 입히기",
    ...
    "docs": [
      ...
      { "title": "Color Ramp", "url": "https://docs.blender.org/manual/en/latest/render/shader_nodes/converter/color_ramp.html" }
    ]
  },
  {
    "week": 7,
    ...
    "docs": [
      ...
      { "title": "Image Texture Node", "url": "https://docs.blender.org/manual/en/latest/render/shader_nodes/textures/image.html" },
  ...
  },
  {
    ...
    "shortcuts": [
      ...
      { "keys": "N → Camera Lock to View", "action": "카메라 따라다니기" }
    ],
    "explore": [
      {
        "title": "HDRI + 3점 조명 조합",
    ...
    "docs": [
      ...
      { "title": "World Environment", "url": "https://docs.blender.org/manual/en/latest/render/lights/world.html" },
      { "title": "Camera", "url": "https://docs.blender.org/manual/en/latest/render/cameras.html" },
      { "title": "Depth of Field", "url": "https://docs.blender.org/manual/en/latest/render/cameras.html#depth-of-field" }
    ]
  },
  {
    "week": 10,
    ...
    "shortcuts": [
      ...
      { "keys": "T", "action": "Interpolation 변경 (Bezier/Linear)" },
      { "keys": "V", "action": "핸들 타입 변경 (Free/Auto)" }
    ],
    "explore": [
      {
        "title": "로봇 걸음걸이 만들기",
    ...
    "docs": [
      ...
      { "title": "Cyclic Extrapolation", "url": "https://docs.blender.org/manual/en/latest/editors/graph_editor/fcurves/modifiers.html" }
    ]
  },
  {
    "week": 11,
    ...
    "shortcuts": [
      ...
      { "keys": "Alt + R", "action": "Rotation 초기화 (Pose)" },
      { "keys": "Alt + G", "action": "Location 초기화 (Pose)" }
    ],
    "explore": [
      {
        "title": "로봇 팔 IK 체험",
    ...
    "docs": [
      ...
      { "title": "Pose Mode", "url": "https://docs.blender.org/manual/en/latest/animation/armatures/posing/index.html" }
    ]
  },
  {
    "week": 12,
    ...
    "shortcuts": [
      ...
      { "keys": "M (Merge by Distance)", "action": "중복 정점 제거" },
      { "keys": "Space", "action": "애니메이션 재생/정지" },
      { "keys": "Shift + N", "action": "법선 재계산" }
    ],
    "explore": [
      {
    ...
    "docs": [
      ...
      { "title": "FBX Import", "url": "https://docs.blender.org/manual/en/latest/addons/import_export/scene_fbx.html" },
  ...
  },
  {
    ...
    "shortcuts": [
      ...
      { "keys": "Esc", "action": "렌더 중지" },
      { "keys": "Z → Rendered", "action": "실시간 렌더 미리보기" },
      { "keys": "Ctrl + B (카메라 뷰)", "action": "렌더 영역 지정 (부분 렌더)" }
    ],
    "explore": [
      {
        "title": "Denoising 비교",
    ...
    "docs": [
      ...
      { "title": "Denoising", "url": "https://docs.blender.org/manual/en/latest/render/cycles/render_settings/sampling.html" }
    ]
  },
  {
    "week": 14,
