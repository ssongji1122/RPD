...
const CURRICULUM = [
  ...
  },
  {
    ...
    "steps": [
      {
        "title": "Camera 배치",
        "copy": "3D 작업에도 사진 촬영처럼 카메라가 있어야 결과물이 나와요. Focal Length는 렌즈 종류, Depth of Field는 조리개라고 생각하면 돼요. 50mm 표준 렌즈로 시작해서 로봇 정면 45도 각도부터 잡아봐요.",
        "goal": [],
        "done": [
          "카메라를 배치하고 Focal Length·DOF를 설정했다",
          "Numpad 0으로 구도를 확인했다"
        ],
        "tasks": [
          {
          ...
          {
            "id": "w13-t2",
            "label": "Location: (4, -4, 3)",
            "detail": ""
          },
          {
            "id": "w13-t3",
            "label": "Numpad 0 으로 Camera 뷰 확인",
            "detail": ""
          },
          {
            "id": "w13-t4",
            "label": "Focal Length: 50mm",
            "detail": ""
          },
          {
            "id": "w13-t5",
        ...
        "image": "assets/images/week13/camera-setup.png",
        "link": "https://docs.blender.org/manual/en/latest/render/cameras.html",
        "showme": "render-settings"
      },
      {
        "title": "Eevee 렌더 테스트 (Blender 5.0 기준)",
        "copy": "Cycles는 사진 인화처럼 정밀하고 느리고, Eevee는 빠른 반복 작업에 유리합니다. (단, 5.0 기준 Eevee는 구버전 튜토리얼의 AO/SSR/Bloom 체크박스 대신 Raytracing/Light Probe 중심으로 품질을 올리는 경우가 많습니다.)",
        "goal": [],
        "done": [
          "Eevee로 빠르게 테스트 렌더를 완료했다"
        ],
        "tasks": [
          {
            "id": "w13-t6",
            "label": "Render Engine: Eevee",
            "detail": ""
          },
          {
            "id": "w13-t7",
            "label": "Render > Raytracing:",
            "detail": ""
          },
          {
            "id": "w13-t8",
            "label": "Bloom 느낌이 필요하면:",
            "detail": ""
          },
          {
            "id": "w13-t9",
            "label": "View Transform: AgX",
            "detail": ""
          },
          {
            "id": "w13-t10",
        ...
        "image": "assets/images/week13/eevee-render.png",
        "link": "https://docs.blender.org/manual/en/latest/render/eevee/introduction.html",
        "showme": "render-settings"
      },
      {
        "title": "Cycles 렌더 비교",
        "copy": "Cycles는 빛 한 줄기씩 일일이 계산해요. 그래서 느리지만 사진처럼 정확해요. Denoising만 켜면 절반 샘플로도 깨끗하게 나와서 시간이 크게 줄어요.",
        "goal": [],
        "done": [
          "Cycles로 렌더해서 Eevee와 품질 차이를 비교했다"
        ],
        "tasks": [
          {
            "id": "w13-t12",
            "label": "Render Engine: Cycles",
            "detail": ""
          },
          {
            "id": "w13-t13",
            "label": "Render Samples: 128",
            "detail": ""
          },
          {
            "id": "w13-t14",
            "label": "F12 렌더 > Eevee와 비교",
            "detail": ""
          }
        ],
        "image": "assets/images/week13/cycles-render.png",
        "link": "https://docs.blender.org/manual/en/latest/render/cycles/introduction.html",
        "showme": "compositing-basics"
      },
      {
        "title": "MCP 카메라 자동화",
        "copy": "Claude한테 \"정면 45도로 카메라 둬\"라고 말하면 그대로 해줘요. 좌표 입력을 한 줄 명령으로 대체할 수 있어요. 여러 앵글을 한 번에 만들 때 가장 효율이 좋아요.",
        "goal": [],
        "done": [
          "MCP 명령으로 카메라·렌더를 자동 실행했다"
        ],
        "tasks": [
          {
            "id": "w13-t15",
            "label": "Claude Desktop에서 3가지 카메라 앵글 자동 설정",
            "detail": ""
          },
          {
            "id": "w13-t16",
            "label": "각 카메라 뷰 확인 > 마음에 드는 앵글로 렌더",
            "detail": ""
          }
        ]
      },
      {
        "title": "AI 영상 생성",
        "copy": "렌더 이미지 한 장이면 Kling AI가 5초 영상으로 만들어줘요. 매일 무료 크레딧(약 66개)으로 5~6개 테스트 가능해요. Google Veo 3(Gemini Pro 구독자)나 Higgsfield(시네마틱 카메라 컨트롤, free tier는 워터마크)도 옵션이지만, 한국 학생이 무료로 가장 편하게 쓰는 건 Kling이에요.",
        "goal": [],
        "done": [
          "렌더 이미지로 AI 영상을 만들었다"
        ],
        "tasks": [
          ...
          {
            "id": "w13-t18",
            "label": "klingai.com > Image to Video > 프롬프트 입력",
            "detail": ""
          },
          {
            "id": "w13-t19",
      ...
      {
        "title": "AI BGM 생성",
        "copy": "Suno AI에 분위기를 한 줄로 적으면 30초 BGM이 두 곡 나와요. 무료 50 크레딧으로 하루 10곡 정도 가능해요. Google Flow Music(Lyria 3, 무료)도 좋은 대안이고, 효과음은 ElevenLabs Music에서 따로 받을 수 있어요. 포트폴리오에 게시할 거면 라이선스를 확인하세요 — 무료 plan은 비상업 한정이에요.",
        "goal": [],
        "done": [
          "AI로 BGM을 생성했다"
        ],
        "tasks": [
          {
            "id": "w13-t20",
            "label": "suno.com > Create > 프롬프트 입력",
            "detail": ""
          },
          {
            "id": "w13-t21",
            "label": "2곡 생성 후 선택 > MP3 다운로드",
            "detail": ""
          },
          {
            "id": "w13-t22",
            "label": "(선택) ElevenLabs에서 효과음도 생성",
            "detail": ""
          }
        ]
      },
      {
        "title": "영상 조합",
        "copy": "한 걸음 더: Blender의 Compositor를 활용하면 렌더링 후 포토샵 없이도 색보정, 글로우, 비네팅 등을 적용할 수 있습니다. Compositing 탭에서 \"Use Nodes\"를 체크하고, Render Layers → Glare(글로우) → Color Balance(색보정) → Composite 순으로 노드를 연결해보세요. 한 번 설정해두면 모든 렌더에 자동 적용되어 일관된 후처리가 가능합니다. 이것은 영화 VFX 업계에서 \"LUT를 태운다\"고 부르는 작업과 같은 원리입니다.",
        "goal": [],
        "done": [
          "AI 영상과 BGM을 하나로 합쳐 프로모션 영상을 만들었다"
        ],
        "tasks": [
          {
            "id": "w13-t23",
            "label": "Blender Video Sequencer 또는 CapCut 열기",
            "detail": "둘 다 무료로 사용 가능"
          },
          {
            "id": "w13-t24",
            "label": "Add > Movie로 AI 영상, Add > Sound로 BGM 트랙 배치",
            "detail": ""
          },
          {
            "id": "w13-t25",
            "label": "영상과 음악 길이를 Strip 끝 드래그로 맞추고 Ctrl + F12 (또는 Export)로 MP4 저장",
            "detail": ""
          }
        ],
        "image": "assets/images/week13/video-sequencer.png",
        "link": "https://docs.blender.org/manual/en/latest/video_editing/introduction.html",
        "showme": "compositing-basics"
      }
    ],
    "shortcuts": [
